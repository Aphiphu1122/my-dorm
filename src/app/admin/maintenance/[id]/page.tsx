      ...
      <main className="flex-1 p-8 max-w-6xl mx-auto">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-4xl font-bold text-gray-900">Maintenance Detail</h1>
          ...
          <div className="bg-white shadow-lg rounded-2xl p-8 mb-8 border border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-800 mb-6">Request Info</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700">
              ...
              <div>
                ...
                <p className="font-medium">{new Date(request.createdAt).toLocaleString("th-TH")}</p>
              </div>
              <div>
          ...
          <div className="bg-white shadow-lg rounded-2xl p-8 border border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-800 mb-6">Reporter & Status</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 text-gray-700">
              <div>
                <p className="text-gray-500 text-sm">Reporter</p>
